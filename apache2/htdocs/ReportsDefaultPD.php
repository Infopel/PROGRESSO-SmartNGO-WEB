...
<H2><?= ($row['name'])?></H2>
<ul>
<li><a href="http://5.189.162.27:84/reportPD.php?p=<?= ($row['id'])?>">Relatorio de Beneficiarios <?= ($row

['name'])?></a></li>
<li><a href="http://5.189.162.27:84/reportOrcamentoPD.php?p=<?= ($row['id'])?>">Relatorio de Orcamento <?= 
...
<form action="reportsDefaultPD.php" method="post">
