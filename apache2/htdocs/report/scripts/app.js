...
(function (angular) {
    ...
    let user_id = user[0].href.replace('http://5.189.162.27:84/redmine/users/', '');
    ...
    $scope.selectPrograma = function (projecto) {
         ...
         * Query Vars
         */
        var url = 'new_system/system/api/utilitesControler.php/?getActs=0&id=' + projecto.id_programa;
        $http.get(url)
    ...
    if(actividade_id !== ""){
        $scope.isNewEntrie = false;
             ...
             */
            var url = 'new_system/system/api/utilitesControler.php/?getAct=0&id_actividade=' + actividade_id;
            $http.get(url)
                .success(function (data) {
                    // $scope.responseAct = data;
    ...
    $scope.gravarReal = function (comment, vGasto, time) {
        ...
        $http.post('new_system/system/api/utilitesControler.php/?store=0', data, config)
     ...
     * Query Vars
     */
        var url = 'new_system/system/api/utilitesControler.php/?getVars=0';
        $http.get(url)
        .success(function (data) {
